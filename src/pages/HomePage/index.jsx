                ...
                <SwiperSlide>
                  <div className="sk-course-box">
                    ...
                    <div className="sk-course-content">
                      ...
                      <p className="sk-smallBox-description">Lorem Ipsum has been the industry's in the standard dummy text ever since the</p>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="sk-begain-box">
                <div class="sk-begain-content">
                  <h6>I want to</h6>
                  <h5>Upskill  <img src={arrowbicon} /> </h5>
                </div>
            ...
            <div class="col-md-4">
              <div class="sk-begain-box">
                <div class="sk-begain-content">
                  <h6>I want to</h6>
                  <h5>Change Career  <img src={arrowbicon} /> </h5>
                </div>
                <div class="sk-begain-img">
                  <img src={begainimg} />
                </div>
            ...
            <div class="col-md-4">
              <div class="sk-begain-box">
                <div class="sk-begain-content">
                  ...
                  <h5>Government Exam  <img src={arrowbicon} /> </h5>
                </div>
                <div class="sk-begain-img">
                  <img src={begainimg} />
                </div>
                ...
                <SwiperSlide>
                  <div className="sk-course-box">
                    ...
                    <div className="sk-course-content">
                      ...
                      <div className="sk-course-btn">
                        <button className="sk-course-btn sk-courseBg-color">Attempt</button>
                      </div>
                    </div>
                  </div>
                </SwiperSlide>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="sk-hireStory-box">
                <div className="sk-hireSotory-innerbox">
                  ...
                  <p>Go nowhere. We here at Shekunj offer the best job opportunities from the best companies. Find a job and move towards your bright future.</p>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="sk-hireStory-box">
                <div className="sk-hireSotory-innerbox sk-woman-story">
                  ...
                  <p>Land your dream job by designing a perfect resume in a print-ready <br/> format</p>
                ...
                <Swiper
                  ...
                  <SwiperSlide>
                    <div className="sk-story-testmonial">
                      ...
                      <div className="sk-story-content">
                        <h4>
                          Dipti is very hard-working as well as dedicated to her work, and this sincerity helped her get promoted to an HR Manager!
                        </h4>
