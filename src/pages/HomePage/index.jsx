...
function HomePage() {
  ...
  const getAllBlogsData = async () => {
    try {
      const url = `${apiConstants.ALL_BLOGS.TRENDING_BLOGS
        }?limit=${10}&offset=${0}`;
      const data = await httpServices.get(url);
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className='sk-heading-title mb-0'>
                <h2>Why our students <span className="sk-favorite-icon">L <FavoriteOutlinedIcon /> VE </span> us?</h2>
                        ...
                        <div className='sk-userReview-box'>
                          ...
                          <span>
                            ...
                            <span className='sk-review-home'>
                              <a href="javascript:;"><GradeRoundedIcon /></a>
                              <a href="javascript:;"><GradeRoundedIcon /></a>
                              <a href="javascript:;"><GradeRoundedIcon /></a>
                              <a href="javascript:;"><GradeRoundedIcon /></a>
                              <a href="javascript:;"><GradeRoundedIcon /></a>
