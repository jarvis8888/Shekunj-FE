...
const CareerDetails = () => {
  ...
  const transformImg = (image) => {
    if (!image) {
      const randomIndex = Math.floor(Math.random() * dummyCollegesLogos.length);
  ...
  return (
    <>
      <SEO
        title={
          topCollages?.meta_title ? topCollages?.meta_title : topCollages?.title
        }
        description={topCollages?.meta_description}
        keywords={topCollages?.meta_keywords}
        image={topCollages?.image}
        currentUrl={currentUrl}
        link={
          topCollages?.canonical_tags ? topCollages?.canonical_tags : currentUrl
        }
      />
      <div>
        <Header
        ...
        <div className='coverMainSecCollege'>
          <div className='college_detail_cover'>
            <img
              src={transformCovImg(topCollages?.default_cover?.image)}
              alt='...'
          ...
          <Row>
            <div md={12} xs={12}>
              <div className='college_logo'>
                <img
                  src={transformImg(topCollages?.logo)}
                  alt='...'
                ...
                <div className='deatil_box'>
                  ...
                  <Row>
                    <Col md={12} xs={12}>
                      <h6>
                        ...
                        : {topCollages && capitalizeFirstLetter(topCollages.city)}
                        {topCollages.city && ","}{" "}
                        {topCollages && capitalizeFirstLetter(topCollages.state)}
                      </h6>
                    </Col>
                    <Col md={12} xs={12}>
                      <h6>
                        ...
                        <span>
                          {topCollages &&
                            capitalizeFirstLetter(topCollages.collage_type)}
                        </span>
                      </h6>
                    </Col>
                  </Row>
                      ...
                      <Col md={6} xs={12}>
                        <h6>
                          ...
                          <a
                            ...
                            href={`https://${topCollages?.website}`}
                          >
                            {topCollages && topCollages?.website}
                          </a>
                    ...
                    <p style={{ textAlign: "justify" }} className='mt-3'>
                      ...
                      <div
                        dangerouslySetInnerHTML={{
                          __html: `<div>${topCollages.about_college}</div>`,
                        }}
                      />
                    </p>
                  )}
                  ...
                  {topCollages.courses_offered && (
                    <p>
                      ...
                      <div
                        dangerouslySetInnerHTML={{
                          __html: `<div>${topCollages.courses_offered}</div>`,
                        }}
                      />
                    </p>
                  )}
                ...
                <div className='deatil_box_right'>
                  ...
                  <Row>
                    {topCollages.image1 && (
                      <Col md={6} xs={12}>
                        <img
                          src={transformGalley(topCollages.image1)}
                          alt='image_gallery'
                    ...
                    {topCollages.image2 && (
                      <Col md={6} xs={12}>
                        <img
                          src={transformGalley(topCollages.image2)}
                          alt='image_gallery'
                          className='right_gallery'
                        />
                      </Col>
                    ...
                    {topCollages.image3 && (
                      <Col md={6} xs={12}>
                        <img
                          src={transformGalley(topCollages.image3)}
                          alt='image_gallery'
                          className='right_gallery'
                        />
                      </Col>
                    ...
                    {topCollages.image4 && (
                      <Col md={6} xs={12}>
                        <img
                          src={transformGalley(topCollages.image4)}
                          alt='image_gallery'
                          className='right_gallery'
                        />
                      </Col>
